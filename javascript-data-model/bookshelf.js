...
console.log('value of second author property:', bookshelf[1].author);
console.log('value of first isbn property:', bookshelf[0].isbn);
console.log('value of third title property:', bookshelf[2].title);
